...
// 4D Global variables
extern int fdComm ;  		// comp port handle, used by Intrinsic routines
...
#define gfx_Vline(x, y1, y2, color) gfx_Line(x, y1, x, y2, color)
#define gfx_Hline(y, x1, x2, color) gfx_Line(x1, y, x2, y, color)
